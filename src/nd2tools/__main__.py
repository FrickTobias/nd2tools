"""
ND2tools is a package for automating common image processes and analyses.
"""
import sys
import logging
import pkgutil
...
from nd2tools import __version__
...
def main(commandline_arguments=None) -> int:
    ...
    parser = ArgumentParser(description=__doc__, prog="nd2tools")
    parser.add_argument(
        "--version",
        action="version",
        version=__version__
